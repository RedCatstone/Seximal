...
<div class="module">
    ...
    <p>
        Converting between different number systems is quite messy. But once you stick to one, this isn't a problem anymore.
        Humans are used to Decimal numbers, so here is the number in <strong>Decimal</strong>.
    </p>
